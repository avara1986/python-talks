...
python benchmark.py -f native_binary_search  -i 10000 -o results/native_binary_search.json
python benchmark.py -f cython_binary_search  -i 10000 -o results/cython_binary_search.json
python benchmark.py -f binary_search  -i 10000 -o results/binary_search.json
